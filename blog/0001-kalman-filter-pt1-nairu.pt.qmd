...
> **Update**: Isso é a Parte 1. Depois da publicação deste post, o autor do post original publicou uma atualização oficial do exercício ([post nº46](https://www.bcb.gov.br/noticiablogbc/46/noticia)) usando dados mais recentes e uma reestimação em estágio único, com a razão sinal-ruído λ livre em vez de calibrada. Na [Parte 2](0001-kalman-filter-pt2-bssm.pt.qmd), replico essa versão atualizada com um pacote Bayesiano (`bssm`, mais uma sintaxe de presente para os leitores), em duas versões, máxima verossimilhança e MCMC, para contrastar as abordagens frequentista e bayesiana.
